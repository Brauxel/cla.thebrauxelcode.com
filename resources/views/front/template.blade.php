...
<html lang="{{ config('app.locale') }}">
  ...
  <body>
    ...
    <header>
        ...
        <div class="brand"><img class="img-responsive logo" src="img/celsius-resources.svg" width="280" alt=""></div>
    ...
    <footer>
        @yield('footer')
        <p class="text-center"><small>Copyright &copy; The Brauxel Code</small></p>
    </footer>
